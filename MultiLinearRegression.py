...
st.markdown("""
            <div class="card">
                ...
                <p> Predict<b>Tip Amount </b> Total Bill <b> Using linear Regression</b></p>""",unsafe_allow_html=True)
...
st.markdown(f"""
            ...
            <p><b> co-efficient(totl-bill):</b>{model.coef_[0]:.3f}<br>
            <b>co-efficient(group size):</b>{model.coef_[1]:.3f}<br>
            <b>intercept:<b> Bill amount</b> and <b> number of people</b>
            </p>
